...
- (void)horizontalPickerViewDidTouched;
// any view returned from this must confirm to the V8HorizontalPickerElementState protocol
- (void)horizontalPickerViewLongPressed:(V8HorizontalPickerView *)picker;
- (void)horizontalPickerViewWillBeginDragging:(V8HorizontalPickerView *)picker;
